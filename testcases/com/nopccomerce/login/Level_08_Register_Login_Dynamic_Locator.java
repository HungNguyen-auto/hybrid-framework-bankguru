...
public class Level_08_Register_Login_Dynamic_Locator extends BaseTest {
    ...
    @Test
    public void Login_04_Switch_Page_At_Footer_Dynamic_Locator() {
        searchPage = (SearchPageObject) ordersPage.getFooterPageByName(driver,"Search");

        myAccountPage = (MyAccountPageObject) homePage.getFooterPageByName(driver, "My account");

        ordersPage = (OrdersPageObject) myAccountPage.getFooterPageByName(driver, "Orders");

...
public class Level_14_Register_Login_Log_Extent_Report extends BaseTest {
	...
	public void Login_01_Register(Method method) {
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,
				"User_01_Register - Steps 10: Verify Success message is displayed");
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,
				"User_01_Register - Steps 12: Verify Home Page Slider is displayed");
	...
	public void Login_02_Login(Method method) {
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,
				"User_02_Register - Steps 02: Input to Email textbox with value: " + emailAddress);
		loginPage.inputToEmailTextbox(emailAddress);

		ExtentTestManager.getTest().log(LogStatus.INFO,
				"User_02_Register - Steps 03: Input to Password textbox with value: " + password);
		...
		ExtentTestManager.getTest().log(LogStatus.INFO,
				"User_02_Register - Steps 05: Verify Home Page Slider is displayed");
		verifyTrue(homePage.isHomePageSliderDisplayed());
